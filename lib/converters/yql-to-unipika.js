(function () {
    ...
    function convertTaggedType(tag, dataType, data, converter) {
        ...
        switch (tag) {
            ...
            case 'videourl':
                if (dataType[0] === 'StructType') {
                    convertedStruct = convertStructToJSON(convertedValue);
                    if (convertedStruct.hasOwnProperty('src') && typeof convertedStruct.src === 'string') {
                        convertedValue = {
                            $type: 'tag_value',
                            $value: convertedStruct
                        };
    ...
    function convert(node, settings, flags) {
        ...
        function yqlToYson(data, dataType) {
            ...
            switch (typeName) {
                ...
                case 'TaggedType':
                    return convertTaggedType(dataType[1], dataType[2], data, yqlToYson);
