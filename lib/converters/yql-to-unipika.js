(function () {
            ...
            case 'audiourl':
                if (dataType[0] === 'StructType') {
                    ...
                    if (
                        ...
                        validateSrcUrl(convertedStruct.src)
                    ) {
                        convertedValue = {
                            $type: 'tag_value',
                            $value: convertedStruct
                ...
                if (typeof convertedValue.$value === 'string' && !validateSrcUrl(convertedValue.$value)) {
                    return convertedValue;
                }
                break;
        }
    ...
    function convert(node, settings, flags) {
        ...
        function yqlToYson(data, dataType) {
            ...
            switch (typeName) {
                ...
                case 'TaggedType':
                    return convertTaggedType(dataType[1], dataType[2], data, yqlToYson, settings.validateSrcUrl);
    ...
    function normalizeSettings(settings) {
        ...
        var validateSrcUrl = settings && settings.validateSrcUrl ? settings.validateSrcUrl : () => false
