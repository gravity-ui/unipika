module.exports = function (_format) {
    ...
    function image(node, imageType, settings = {}) {
        ...
        function buildComplexImage() {
            var src = buildMediaSrc(imageType, node.$value.src, settings);
            if (!asHTML) {
                return src
            }
            var constraints = {
    ...
    function audio(audioBlob, audioType, settings) {
        ...
        var src = buildMediaSrc(audioType, audioBlob, settings);
        return asHTML ?
    ...
    function urlPlugin(node, settings, level) {
        ...
        function formatSimpleUrl() {
            ...
            var formattedHref = utils.normalizeUrl(node.$value, settings);
        ...
        function formatNamedUrl() {
            ...
            var formattedHref = utils.normalizeUrl(node.$value.href || '', settings);
